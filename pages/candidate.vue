        ...
        <div class="relative">
          <main class="main-container w-full">
            <div class="flex flex-col h-full lg:h-[91.5vh] px-5 pt-5">
              ...
              <footer class="flex items-center justify-center py-3 mt-auto mb-2">
...
const consoleData4 = async () =>{
  var button1 = document.getElementById("btn4");
    ...
    console.log("text",num)
let result = await currentUser.callFunction("getData1",num);
